...
if __name__ == "__main__":
    if len(sys.argv) > 1 and sys.argv[1] == "test-discord":
        send_discord_notification("🚀 Test notification: Oyl Corp Auto Clockin #1 Discord integration is working!")
